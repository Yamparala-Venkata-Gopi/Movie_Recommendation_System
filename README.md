...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone git@github.com:venkata-buildverge/Movie_Recommendation_System.git
     ```
